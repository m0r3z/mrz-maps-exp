...
3. (Si chaînes traduisibles modifiées) regénérer le POT : `php /tmp/wp-cli.phar i18n make-pot . languages/mrz-maps-exp.pot --domain=mrz-maps-exp --package-name="MRZ Maps Experience"`
