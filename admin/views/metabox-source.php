...
<table class="form-table mrz-maps-exp-table">
	<tbody>
		<tr>
			<th scope="row">
				<label for="mrzme_source_pt"><?php esc_html_e( 'Post type source', 'mrz-maps-exp' ); ?></label>
			</th>
			<td>
				<select name="mrz_maps_exp[source_pt]" id="mrzme_source_pt" class="mrz-maps-exp-source-pt">
		...
		<tr>
			<th scope="row">
				<label for="mrzme_acf_field"><?php esc_html_e( 'Champ ACF des coordonnées', 'mrz-maps-exp' ); ?></label>
			</th>
			<td>
				<input type="text" name="mrz_maps_exp[acf_field]" id="mrzme_acf_field" value="<?php echo esc_attr( $values['acf_field'] ); ?>" class="regular-text" />
				<p class="description"><?php esc_html_e( 'Nom du champ ACF de type « Google Map » qui contient les coordonnées.', 'mrz-maps-exp' ); ?></p>
			</td>
		</tr>
		<tr>
			<th scope="row">
				<label for="mrzme_limit"><?php esc_html_e( 'Nombre max de posts', 'mrz-maps-exp' ); ?></label>
			</th>
			<td>
				<input type="number" name="mrz_maps_exp[limit]" id="mrzme_limit" value="<?php echo esc_attr( $values['limit'] ); ?>" min="0" step="1" />
				<p class="description"><?php esc_html_e( 'Limite de chargement côté serveur. 0 = illimité.', 'mrz-maps-exp' ); ?></p>
			</td>
		</tr>
		<tr>
			<th scope="row">
				<label for="mrzme_per_page"><?php esc_html_e( 'Posts par page (liste)', 'mrz-maps-exp' ); ?></label>
			</th>
			<td>
				<input type="number" name="mrz_maps_exp[per_page]" id="mrzme_per_page" value="<?php echo esc_attr( $values['per_page'] ); ?>" min="0" step="1" />
